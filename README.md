...
Changes the text to something else cursed. As of **v7 Pre-release 12**, WilloIzCitron contributed, changing the logic tooltips. Stay tuned for more updates!
...
[Latest Release](https://github.com/SMOLKEYS/bundles/releases/tag/v7-pre12)
